...
const Dua = ({dua,index}) => {
    ...
    return (
        ...
        {!dua ? 's':<div className='card max-w-full shadow-md '>
        <div className='card-body'>
        <div className='flex gap-2 items-center '><Image src={a} width={35} height={35} alt='a' ></Image> <span className='text-[#1FA45B] font-[600]'>{index+1}.{dua_name_en}</span> </div>
  ...
  <div className="flex-1">
    <a className="btn btn-ghost text-xl"><Image src={play} width={35} height={35} alt='a' ></Image></a>
  </div>
